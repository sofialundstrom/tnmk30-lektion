 <?php
    ...
    if (isset($_POST['vikt']) && isset($_POST['reps'])) {
        if (isset($_POST['vikt']) && isset($_POST['reps']) != "") {
            if ($_POST['reps'] > 12) {
                $_POST['reps'] = 12;
                $sql2 = "INSERT INTO lyft (lyftID,person, övning, reps, vikt, umax, datum) VALUES (NULL, '1', '1', '" . $_POST['reps'] ."','" . $_POST['vikt'] . "','" . ($_POST['vikt'] * $faktor[$_POST['reps']]) . "','" . "$timestamp" . "')";
...
<head>
    <meta charset="utf-8">
    <title>Frontböj</title>
</head>
<body class="övnignar">
    <?php include('../php/header.php'); ?>
    <form action="två.php" method="POST">
        <fieldset>
            <legend>Frontböj</legend>
            <ol>
                <li>
