 <?php
    ...
    if (isset($_POST['vikt']) && isset($_POST['reps'])) {
        if (isset($_POST['vikt']) && isset($_POST['reps']) != "") {
            if ($_POST['reps'] > 12) {
                $_POST['reps'] = 12;
                $sql6 = "INSERT INTO lyft (lyftID,person, övning, reps, vikt, umax, datum) VALUES (NULL, '1', '8', '" . $_POST['reps'] ."','" . $_POST['vikt'] . "','" . ($_POST['vikt'] * $faktor[$_POST['reps']]) . "','" . "$timestamp" . "')";
...
<head>
    <meta charset="utf-8">
    <title>Utfallsteg</title>
</head>
<body class="övnignar">
    <?php include('../php/header.php'); ?>
    <form action="sex.php" method="POST">
        <fieldset>
            <legend>Utfallsteg</legend>
            <ol>
                <li>
